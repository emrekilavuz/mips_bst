.data
tree: .word 0  ## address
list : .word 50, 25, 75, 3, 12, 33, , 77, 66, 83, -9999
queue1: .word 0 ##  address
queue2: .word 0 ##  address
line: .asciiz "\n"
space: .asciiz " "
x: .asciiz "X"
output_level_order_tree: .asciiz "The numbers in level order:\n"
input_menu: .asciiz "Menu\nPlease enter a value\nTo exit 0\nFor insert: 1\nFor find: 2\nFor print: 3\n"
...
pop_queue_start_1:    #########FOR QUEUE1,  QUEUE HEAD POINTER AT $A3
	...
	sw $a3, 12($sp)
pop_body1:
	beqz $a3, pop_queue_end2  ### if tree head is null
	lw $s3, 4($a3)
	lw $v0, 0($a3)
	sw $s3, queue1
pop_queue_end:
